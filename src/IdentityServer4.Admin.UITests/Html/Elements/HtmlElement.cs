...
namespace IdentityServer4.Admin.UITests.Html.Elements
{
    ...
    {
        protected readonly IWebElement _wrappedElement;
        ...
        {
            get { return _wrappedElement.GetProperty("innerHTML"); }
        ...
        {
            get { return _wrappedElement.GetProperty("textContent") as String; }
            //set { _wrappedElement.SetPropery("textContent", value); }
        }
